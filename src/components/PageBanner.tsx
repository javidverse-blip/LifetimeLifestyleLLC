export function PageBanner({ eyebrow, title, children }: { eyebrow: string; title: string; children: React.ReactNode }) {
  return (
    <section className="flex min-h-[280px] items-center bg-[#05698e] px-5 py-14 text-center">
      <div className="mx-auto max-w-3xl">
        <p className="font-montserrat text-sm font-bold uppercase tracking-[.22em] text-[#feca05]">{eyebrow}</p>
